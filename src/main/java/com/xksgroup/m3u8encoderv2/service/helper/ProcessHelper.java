...
public class ProcessHelper {
    ...
    /**
     * Check if a process is running for a job
     */
    public boolean isProcessRunning(String jobId) {
        Process process = runningProcesses.get(jobId);
    ...
    /**
     * Cleanup all processes (useful for shutdown)
     */
    public void cleanupAllProcesses() {
        log.info("Cleaning up all running processes");
        
        runningProcesses.forEach((jobId, process) -> {
            if (process.isAlive()) {
